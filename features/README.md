...
`_core.lua` holds the shared helpers (config table, toggle/slider helpers, notifications, targeting ...). Everything here is generated by `tools/build_features.py`; edit the hub and rebuild, not these files.
