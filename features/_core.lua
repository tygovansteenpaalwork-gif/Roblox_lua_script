...
local win = UI:Window({
    Title = string.upper(opts.Title or "TERKAN"),
    Version = "V " .. U.Version:match("^%d+%.%d+"),
    Footer = "Terkan features",
...
return {
    ...
    predicted = predicted,
    cursorOverMenu = cursorOverMenu,
    virtualClick = virtualClick,
    fireWeapon = fireWeapon,
    ensureToolEquipped = ensureToolEquipped,
    Players = Players,
    ...
    NOTIF_TITLES = NOTIF_TITLES,
    showToast = showToast,
    overlay = overlay,
    toasts = toasts,
    TOAST_LINE = TOAST_LINE,
    rayParams = rayParams,
    randomPick = randomPick,
    AIM_TYPES = AIM_TYPES,
    TARGET_PARTS = TARGET_PARTS,
    PRIORITIES = PRIORITIES,
    FIRE_METHODS = FIRE_METHODS,
    myHumanoid = myHumanoid,
    typing = typing,
    playerNames = playerNames,
    addPlayerPicker = addPlayerPicker,
    Ready = Ready,
}
end
